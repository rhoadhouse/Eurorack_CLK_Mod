...
avr-gcc user_buttons.c -o user_buttons.o -c -mmcu=atmega328p -DF_CPU=16000000UL -Os

avr-gcc main.c -o main.o -c -mmcu=atmega328p -DF_CPU=16000000UL -Os
avr-gcc -o ClkMod.elf main.o gpio.o functions.o uart.o user_buttons.o -mmcu=atmega328p -DF_CPU=16000000UL -Os -Wl,-u,vfprintf -lprintf_flt -lm
